...
var firstNameMale = []string{"伟", "强", "磊", "洋", "勇", "军", "杰", "涛", "超", "明",
	"刚", "平", "辉", "鹏", "华", "飞", "鑫", "波", "斌", "宇",
	"浩", "凯", "健", "俊", "帆", "帅", "旭", "宁", "龙", "林",
...
var firstNameFemale = []string{"芳", "娜", "敏", "静", "敏静", "秀英", "丽", "洋", "艳", "娟",
...
func (p Person) Name() string {
	return util.GetRandValue(lastName) + util.GetRandValue(append(firstNameMale, firstNameFemale...))
}
